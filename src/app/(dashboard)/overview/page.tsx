...
import CashFlowTrendChart from '@/components/overview/CashFlowTrendChart'
    ...
    <div className="fink-dashboard-page">
      ...
      {!hasPremiumAccess ? (
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'14px' }}>
          ...
          {/* Top categories */}
          <Card>
            <CardHead title="Top Spending Categories" icon={<AppIcon name="expense" size={16} />} subtitle="Kategori dengan pengeluaran terbesar" right={<Link href="/journal" style={{ fontSize:'11px', color:'#1a5c42', fontWeight:700, textDecoration:'none' }}>Detail</Link>} />
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'14px' }}>
          {/* Smart saving */}
          <Card>
            <CardHead title="Priority Goals" subtitle="Target utama yang paling perlu dipantau" right={<Link href="/goals" style={{ fontSize:'11px', color:'#1a5c42', fontWeight:700, textDecoration:'none' }}>Kelola</Link>} />
          ...
          {/* Recent transactions */}
          <Card>
            <CardHead title="Recent Transactions" icon={<AppIcon name="transactions" size={16} />} subtitle="Transaksi terbaru bulan ini" right={<Link href="/journal" style={{ fontSize:'11px', color:'#1a5c42', fontWeight:700, textDecoration:'none' }}>Tambah</Link>} />
